...
export default function TransactionList({ transactions }) {
  return (
    <div className="bg-[#161616] rounded-2xl border border-[#222] overflow-hidden p-4 sm:p-6 md:col-span-8">
              ...
              >
                <td className="py-4 pl-4">
                  <div className="flex items-center min-w-0">
                    <div className="w-10 h-10 rounded-xl bg-[#222] border border-[#333] group-hover:border-[#444] flex items-center justify-center mr-4 transition-colors shrink-0">
                      {t.amount >= 0 ? (
