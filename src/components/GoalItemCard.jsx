...
export default function GoalItemCard({ goal, openFundModal }) {
  ...
  return (
    <div className={`bg-[#161616] border ${isCompleted ? 'border-cyan-500/40 shadow-[0_0_20px_rgba(34,211,238,0.05)]' : 'border-[#222] hover:border-[#333]'} transition-all duration-300 rounded-2xl p-6 relative overflow-hidden group`}>
      {isCompleted && (
        <div className="absolute -right-8 top-5 bg-cyan-500/20 text-cyan-200 text-[9px] font-bold py-1 px-10 rotate-45 border-b border-cyan-500/30">
          COMPLETED
        </div>
      )}
      <div className="flex justify-between items-start mb-6 relative z-10">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-[#222] border border-[#333] flex items-center justify-center text-cyan-200">
      ...
      <div className="w-full bg-[#2a2a2a] rounded-full h-1.5 mb-3 overflow-hidden relative z-10">
        <div
          className="bg-cyan-200 h-full rounded-full transition-all duration-1000 ease-out shadow-[0_0_8px_rgba(34,211,238,0.5)]"
          style={{ width: `${percent}%` }}
        ></div>
      </div>
